...
class Box3DItem(QGraphicsItem):
    ...
    def __init__(self, kind: str, model, camera: Camera, grid_snap_mm: float = 50.0):
        super().__init__()
        ...
        self.setZValue(1 if kind == "wall" else 10)
...
class Interactive3DScene(QGraphicsScene):
    ...
    def rebuild_from_floor(self, floor: Floor, undo_stack) -> None:
        ...
        for wall in floor.walls:
            self.addItem(Box3DItem("wall", wall, self.camera, self.grid_snap_mm))
